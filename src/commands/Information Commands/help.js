        ...
        const collector = m.createMessageComponentCollector({
            filter: (b) => {
                if (b.user.id === message.member.user.id) return true;
                    ...
                    b.reply({ ephemeral: true, content: `Only **${message.member.user.tag}** can use this menu, run the command again.` }); return false;
                };
            },
            ...
            if (i.customId === "helpMenu") {
                ...
                if (value[0] === "home") {
                    ...
                    editEmbed
                        ...
                        .setFooter({ text: (`© SXM_ABEL | Total: ${_commands.length} Economy Commands`) })
                    if (!m) return;
                    ...
                    editEmbed
                        ...
                        .setFooter({ text: (`© SXM_ABEL | Total: ${_commands.length} Information Commands`) })
                    if (!m) return;
                    return await m.edit({ embeds: [editEmbed], components: [row] })
                    ...
                    editEmbed
                        ...
                        .setFooter({ text: (`© SXM_ABEL | Total: ${_commands.length} Configureation Commands`) })
                    if (!m) return;
                    return await m.edit({ embeds: [editEmbed], components: [row] })
                }
            }
