 ...
 module.exports = {
     ...
     run: async (client, interaction) => {
         ...
         const row = new MessageActionRow()
             .addComponents(
                 new MessageButton()
                     .setLabel("Invite")
                     .setStyle("LINK")
                     .setURL("https://discord.com/api/oauth2/authorize?client_id=977978260883386388&permissions=8&scope=bot%20applications.commands"),
         ...
         const embed = new MessageEmbed()
             ...
             .setThumbnail('')
             .setColor('#ff7f50s')
             .addField('Creator', '[SXM_ABEL#2140](https://github.com/SxMAbel) And [Fire Hybrid#8899](https://github.com/edwardivan)', true)
             .addField('Organization', '[Abel Purnwasy](https://github.com/SxMAbel)', true)
             .addField('Repository', '[Click Here](https://github.com/SxMAbel/economyBot)', true)
             .addField('\u200b',
