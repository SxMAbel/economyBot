...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const notEnough = new MessageEmbed()
      ...
      .setFooter({ text: "© SXM_ABEL" });
    if (amount > userBal)
      return await interaction.editReply({ embeds: [notEnough] });
    ...
    const minimumLimit = new MessageEmbed()
      ...
      .setFooter({ text: "© SXM_ABEL" });
    if (amount < 50)
      return await interaction.editReply({ embeds: [minimumLimit] });
    ...
    const maximumLimit = new MessageEmbed()
      ...
      .setFooter({ text: "© SXM_ABEL" });
    if (amount === userBal)
      return await interaction.editReply({ embeds: [maximumLimit] });
